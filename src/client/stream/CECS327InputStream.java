...
import client.proxy.ProxyInterface;
...
public class CECS327InputStream extends InputStream {
    ...
    */
    ...
    /**
     * Reads the next byte of data from the input client.stream.
    */
    @Override
    ...
    /**
     * Reads some number of bytes from the input client.stream and stores them
    ...
    */
    ...
    /**
     * Skips over and discards n bytes of data from this input client.stream.
    */
    @Override
     ...
     * (or skipped over) from this input client.stream without blocking by
     * the next invocation of a method for this input client.stream.
    */
    @Override
    ...
    /**
     * Tests if this input client.stream supports the mark and reset methods.
    */
    @Override
    ...
    /**
     * Marks the current position in this input client.stream.
    */
    @Override
    ...
    /**
     * Repositions this client.stream to the position at the time the
     * mark method was last called on this input client.stream.
    */
    @Override
    ...
    /**
     * Closes this input client.stream and releases any system resources
     * associated with the client.stream.
    */
    @Override
